...
{
    [ 0] = { "Food",         0, 0, 19,  -2,   6, 0x01, TONNES },
    [ 1] = { "Textiles",     0, 0, 20,  -1,  10, 0x03, TONNES },
    [ 2] = { "Radioactives", 0, 0, 65,  -3,   2, 0x07, TONNES },
    [ 3] = { "Slaves",       0, 0, 40,  -5, 226, 0x1F, TONNES },
    [ 4] = { "Liquor/Wines", 0, 0, 83,  -5, 251, 0x0F, TONNES },
    [ 5] = { "Luxuries",     0, 0, 196,  8,  54, 0x03, TONNES },
    [ 6] = { "Narcotics",    0, 0, 235, 29,   8, 0x78, TONNES },
    [ 7] = { "Computers",    0, 0, 154, 14,  56, 0x03, TONNES },
    [ 8] = { "Machinery",    0, 0, 117,  6,  40, 0x07, TONNES },
    [ 9] = { "Alloys",       0, 0, 78,   1,  17, 0x1F, TONNES },
    [10] = { "Firearms",     0, 0, 124, 13,  29, 0x07, TONNES },
    [11] = { "Furs",         0, 0, 176, -9, 220, 0x3F, TONNES },
    [12] = { "Minerals",     0, 0, 32,  -1,  53, 0x03, TONNES },
    [13] = { "Gold",         0, 0, 97,  -1,  66, 0x07, KILOGRAMS },
    [14] = { "Platinum",     0, 0, 171, -2,  55, 0x1F, KILOGRAMS },
    [15] = { "Gem-Stones",   0, 0, 45,  -1, 250, 0x0F, GRAMS },
    [16] = { "Alien Items",  0, 0, 53,  15, 192, 0x07, TONNES },
};
...
void scoop_item(int un)
{
    ...
    if( (cmdr.fuel_scoop == 0) || (universe[un].location.y >= 0) || (total_cargo() == cmdr.cargo_capacity) )
    {
        explode_object( un );
